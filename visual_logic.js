 ...
 * Sun Aug 23 2020 05:51:36 GMT+0300 (Москва, стандартное время)
...
handleAnnot(true, '1', 'big_knife_annotation', 'большой нож', 'an_1');
handleAnnot(true, '2', 'small_knife_annotation', 'маленький нож', 'an_2');
handleAnnot(true, '3', 'corkscrew_annotation', 'Штопор', 'an_3');
handleAnnot(true, '4', 'can-opener_annotation', 'консервный нож', 'an_4');
handleAnnot(true, '5', 'bottle_opener_annotation', 'открывалка', 'an_5');
handleAnnot(true, '6', 'awl_annotation', 'Шило', 'an_6');
handleAnnot(true, '7', 'key_ring_annotation', 'брелок для ключей', 'an_7');
handleAnnot(true, '8', 'tweezers_annotation', 'Щипчики', 'an_8');
handleAnnot(true, '9', 'toothpick_annotation', 'Зубочистка', 'an_9');
handleAnnot(true, '10', 'scissors_annotation', 'Ножницы', 'an_10');
handleAnnot(true, '11', 'hook_annotation', 'Крюк', 'an_11');
handleAnnot(true, '12', 'saw_annotation', 'Деревянная Пила', 'an_12');
setHTMLElemStyle('display', 'none', ['an_1', 'an_2', 'an_4', 'an_5', 'an_10', 'an_12'], false);
